...
@Entity(name = "CH09_MODEL6_MEMBER")
@SequenceGenerator(
	name = "CH09_MODEL6_MEMBER_SEQ_GENRATOR"
	, sequenceName = "CH09_MODEL6_MEMBER_SEQ"
	, initialValue = 1
	, allocationSize = 1
)
...
public class Member extends BaseEntity {
	...
	@Id @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CH09_MODEL6_MEMBER_SEQ")
