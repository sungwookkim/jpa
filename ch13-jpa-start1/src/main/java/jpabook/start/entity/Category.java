...
@Entity(name = "CH14_CATEGORY")
@SequenceGenerator(
	name = "CH14_CATEGORY_SEQUENCE"
	, sequenceName = "CH14_CATEGORY_SEQ"
	, initialValue = 1
	, allocationSize = 1
)
...
public class Category extends BaseEntity {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE , generator = "CH14_CATEGORY_SEQ")
