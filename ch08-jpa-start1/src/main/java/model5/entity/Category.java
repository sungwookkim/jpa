...
@Entity(name = "CH08_MODEL5_CATEGORY")
@SequenceGenerator(
	name = "CH08_MODEL5_CATEGORY_SEQUENCE"
	, sequenceName = "CH08_MODEL5_CATEGORY_SEQ"
	, initialValue = 1
	, allocationSize = 1
)
...
public class Category extends BaseEntity {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE , generator = "CH08_MODEL5_CATEGORY_SEQ")
