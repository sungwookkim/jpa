...
@Entity(name = "CH08_MODEL5_MEMBER")
@SequenceGenerator(
	name = "CH08_MODEL5_MEMBER_SEQ_GENRATOR"
	, sequenceName = "CH08_MODEL5_MEMBER_SEQ"
	, initialValue = 1
	, allocationSize = 1
)
...
public class Member extends BaseEntity {
	...
	@Id @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CH08_MODEL5_MEMBER_SEQ")
