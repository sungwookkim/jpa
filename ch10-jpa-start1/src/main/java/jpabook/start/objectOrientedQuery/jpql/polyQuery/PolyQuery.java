...
import jpabook.start.objectOrientedQuery.jpql.entity.item.Album;
import jpabook.start.objectOrientedQuery.jpql.entity.item.Book;
import jpabook.start.objectOrientedQuery.jpql.entity.item.Movie;
import jpabook.start.objectOrientedQuery.jpql.entity.item.abs.Item;

public class PolyQuery extends JpqlCommon {
	...
	public static void main(String[] args) {
		...
		new Logic(JPA_AUTO.UPDATE)
			.commitAfter(em -> {
				System.out.println("=============== 다형성 쿼리 조회 ===============");
				
				System.out.println("--------------- Item 조회 ---------------");
				 ...
				 */
				System.out.println("--------------- TREAT(JPA2.1) ---------------");
				em.createQuery("SELECT i"
					+ " FROM CH10_ITEM i"
				 ...
				 * </properties>
				 */
				System.out.println("--------------- 사용자 정의 함수 호출(JPA2.1) ---------------");
				...
				System.out.println("--------------- [@NamedQueries] Named 쿼리: 정적 쿼리 ---------------");
				...
				System.out.println("--------------- [xml] Named 쿼리: 정적 쿼리 ---------------");
