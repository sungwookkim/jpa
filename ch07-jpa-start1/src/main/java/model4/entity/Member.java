...
@Entity(name = "CH07_MODEL4_MEMBER")
@SequenceGenerator(
	name = "CH07_MODEL4_MEMBER_SEQ_GENRATOR"
	, sequenceName = "CH07_MODEL4_MEMBER_SEQ"
	, initialValue = 1
	, allocationSize = 1
)
...
public class Member extends BaseEntity {
	...
	@Id @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CH07_MODEL4_MEMBER_SEQ")
