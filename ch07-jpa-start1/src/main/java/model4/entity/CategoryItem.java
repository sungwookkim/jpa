...
@Entity(name = "CH07_MODEL4_CATEGORY_ITEM")
@SequenceGenerator(
	name = "CH07_MODEL4_CATEGORY_ITEM_SEQUENCE"
	, sequenceName = "CH07_MODEL4_CATEGORY_ITEM_SEQ"
	, initialValue = 1
	, allocationSize = 1
)
...
public class CategoryItem extends BaseEntity {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CH07_MODEL4_CATEGORY_ITEM_SEQ")
